...
# Version & progress
This translation is generated from the branch [Head](https://crowdin.com/project/magento-2/no#/Head) at Crowdin and based on the Magento Head sourcefiles.
...
# Contribute
To help move the '*Norwegian (norsk) Magento2 Language Pack (no_NO)*' forward please goto [this](https://crowdin.com/project/magento-2/no) crowdin page and translate the untranslated string or propose better translations.
